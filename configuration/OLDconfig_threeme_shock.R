...
lastyear <- 2050              # At least 2050 for standard shock simulations
...
Rsolver = TRUE #TRUE          # If TRUE, will try to Use R solver if possible; If FALSE, use Eviews 
rcpp_option = TRUE # ANISSA : FIND A WAY TO DISABLE IF NOT COMPATIBLE 
