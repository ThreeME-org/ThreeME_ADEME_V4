...
series <- c("POP", "GR_PROG_L") %>% tolower
...
baseline_ch3 <- load_excel_calibration(excel_sheet = "data/input/Luxembourg/scenarii_inputs_statec.xlsx",
...
#baseline_ch <- merge(baseline_ch2, baseline_ch3)
