...
iso3 <- "LUX"                   %>% tolower()
scenario <- c("ct1","expg1","exr10","ff10","inct1","rrsc1","vat1","wd1","prode10","prodk10","prodl10","tpf10")   %>% tolower()
classification <- "c23_s26"       %>% tolower()
model_folder <- "threeme"
project_name <- "standard_shocks_statec"
...
lists_files <- c(
    ...
    "lists_margins.mdl",                                            # DEPRECATED: trade and transport margins are zero (selling price instead of purchasing price) 
...
calib_files <- c(lists_files,
  ...
  "data/Exception_margins_data.mdl",         # DEPRECATED: trade and transport margins are zero (selling price instead of purchasing price) 
...
model_files = c(lists_files,
  ...
  "Exception_margins.mdl",         # DEPRECATED: trade and transport margins are zero (selling price instead of purchasing price) 
  ...
  "Exception_LUX_NEAM.mdl",         # LUX Development Version (to be put in exception_iso3 and deleted when finished)
  "Exception_LUX_POP.mdl",          # LUX Development Version (to be put in exception_iso3 and deleted when finished)
  "Exception_LUX_EXPORTFUEL.mdl",   # LUX Development Version (to be put in exception_iso3 and deleted when finished)
  "Exception_LUX_FITSCENAR.mdl",    # LUX Development Version (to be put in exception_iso3 and deleted when finished)
