...
iso3 <- "FRA"                                    %>% tolower()
scenario <- "ct1"                          %>% tolower()   # "stand" for standard shock simulations (!!! works with main_shock.R)
classification <- "c28_s32"                      %>% tolower()
...
calib_files <- c(lists_files,
  ...
  str_c("data/R_ExtraCalibration_BUIL_", iso3,"_",classification, ".mdl"),      # ADEME VERSION
  str_c("data/R_ExtraCalibration_TRANSPORT_", iso3,"_",classification,".mdl"),  # ADEME VERSION
  "data/parameters.mdl",                                                        # ALL VERSIONS
     
  # Calibration of elasticity of substitutions (Producer)
  "data/elasticities.mdl",                                                      # ALL VERSIONS
  str_c("data/Exception_elasticities_", iso3,"_",classification, ".mdl"),       # ALL VERSIONS : When sector specific elasticity
  str_c("data/R_ExtraCalibration_elas_KLEM_", iso3,"_",classification,".mdl"),  # ADEME VERSION
  str_c("data/R_ExtraCalibration_elas_nrj_", iso3,"_",classification, ".mdl"),  # ADEME VERSION 
  ...
  "data/Exception_housing_data.mdl",                    # ADEME VERSION 
  "data/Exception_Transport_data.mdl",                  # ADEME VERSION
  "data/Exception_FRA_c28_s32_ADEME_data.mdl",         # ADEME VERSION
...
model_files = c(lists_files,
  ...
  "Exception_housing.mdl",                # ADEME VERSION 
  "Exception_Transport.mdl",              # ADEME VERSION 
  "Exception_FRA_c28_s32_ADEME.mdl",      # ADEME VERSION
...
calib_baseline <- file.path("configuration","scenarii_calib","1_calib_baseline_ademe.R")
...
warning = TRUE #FALSE     # If TRUE, will provide solver warning messages
