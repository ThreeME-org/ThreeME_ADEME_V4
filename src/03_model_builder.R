...
####### If model must be recompiled
  ...
  tresthor::export_model(threeme,filename = file.path("src","R_solver_files","model_thor.txt"))
  tresthor::save_model(threeme,folder_path  = file.path("src","R_solver_files/") )
  ...
  tresthor::load_model(file = file.path("src","R_solver_files","threeme.rds"))
