...
curve_sc_plot_country <- function(data , variable, group_type = "sector",
                          country = NULL,
  ...
  liste_var <- var_vec[grep(paste0("^",variable,"_",group,"[A-Z0-9]{3}","_",country,"$"),var_vec)]
