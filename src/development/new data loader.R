##### EXEMPLE FOR FULL DISAGGREGATED
# csv.file.path = file.path("data","temp","csv", "ct1.csv")
# scenario_label = NULL
# variables_to_keep = NULL
# variables_to_keep = c("GDP","PCH", "PLOP")

source("src/bridges/codenames_c29_s33.R")
source("src/bridges/bridge_c29_s33.R")
...
data <- data_list %>% reduce(full_join, by = c("year", "variable","baseline", "sector" , "commodity")) |> add_com_sec_names() |>  as.data.frame()
toc()


### ### ### ### ### ### ### ### ### ### ### ### ### ### 
### ### Function to reaggregate sector commodidity  ### ### 
### ### ### ### ### ### ### ### ### ### ### ### ### ### 
