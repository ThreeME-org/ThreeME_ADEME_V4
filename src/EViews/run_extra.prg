...
subroutine run_scenario(string %scenario_name)
  ...
  if %scenario_name = "baseline_GBR" then
    ...
    smpl {%baseyear} @last
    call load_excel("UK", "uk_scenarii", "baseline")
    call interpolate("PWD_CCOI PWD_CFUT PWD_CGAS PWD_CCOA phiy_toe_cele_senu phiy_toe_cele_seoi phiy_toe_cele_sega phiy_toe_cele_seco phiy_toe_cele_sewi phiy_toe_cele_seso phiy_toe_cele_sehy phiy_toe_cele_seot")
 ...
 ' Any other scenario 
  ...
  call load_excel("UK", "uk_scenarii", %scenario_name)
