...
source(file.path("configuration","config_hacienda.R"))
# file.edit(file.path("configuration","config_hacienda.R"))
...
if(annexes==TRUE){
  for (scen in scenario){
    ...
    rmarkdown::render(input = file.path("results","report","markdown","results_slides.qmd"),
